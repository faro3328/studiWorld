...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220617_studiworld_c8f6ce4b962cb2b61622_20220617131039_archive.zip';
	const ARCHIVE_SIZE		 = '88803062';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c8f6ce4-17131039';
    const SECONDARY_PACKAGE_HASH = '979b029-17131039';
	const VERSION			 = '1.4.6';
